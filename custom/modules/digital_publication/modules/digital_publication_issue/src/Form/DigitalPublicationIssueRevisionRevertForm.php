...
/**
 * Provides a form for reverting a Digital publication issue revision.
 *
 * @ingroup digital_publication_issue
 */
class DigitalPublicationIssueRevisionRevertForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a new DigitalPublicationIssueRevisionRevertForm.
   *
  ...
  public function getFormId() {
    return 'digital_publication_issue_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Digital publication issue: reverted %title revision %revision.', ['%title' => $this->revision->label(), '%revision' => $this->revision->getRevisionId()]);
    drupal_set_message(t('Digital publication issue %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\digital_publication_issue\Entity\DigitalPublicationIssueInterface $revision
