...
/**
 * Defines the Digital serial issue entity.
 *
 * @ingroup digital_serial_issue
 *
 * @ContentEntityType(
 *   id = "digital_serial_issue",
 *   label = @Translation("Digital serial issue"),
 *   handlers = {
 *     "storage" = "Drupal\digital_serial_issue\DigitalSerialIssueStorage",
 *     "view_builder" = "Drupal\Core\Entity\EntityViewBuilder",
 *     "list_builder" = "Drupal\digital_serial_issue\DigitalSerialIssueListBuilder",
 *     "views_data" = "Drupal\digital_serial_issue\Entity\DigitalSerialIssueViewsData",
 *
 *     "form" = {
 *       "default" = "Drupal\digital_serial_issue\Form\DigitalSerialIssueForm",
 *       "add" = "Drupal\digital_serial_issue\Form\DigitalSerialIssueForm",
 *       "edit" = "Drupal\digital_serial_issue\Form\DigitalSerialIssueForm",
 *       "delete" = "Drupal\digital_serial_issue\Form\DigitalSerialIssueDeleteForm",
 *     },
 *     "access" = "Drupal\digital_serial_issue\DigitalSerialIssueAccessControlHandler",
 *     "route_provider" = {
 *       "html" = "Drupal\digital_serial_issue\DigitalSerialIssueHtmlRouteProvider",
 *     },
 *   },
 *   base_table = "digital_serial_issue",
 *   revision_table = "digital_serial_issue_revision",
 *   revision_data_table = "digital_serial_issue_field_revision",
 *   admin_permission = "administer digital serial issue entities",
 *   entity_keys = {
 *     "id" = "id",
 *     "revision" = "vid",
 *     "label" = "name",
 ...
 *     "version-history" = "/admin/structure/digital_serial_issue/{digital_serial_issue}/revisions",
 *     "revision" = "/admin/structure/digital_serial_issue/{digital_serial_issue}/revisions/{digital_serial_issue_revision}/view",
 *     "revision_revert" = "/admin/structure/digital_serial_issue/{digital_serial_issue}/revisions/{digital_serial_issue_revision}/revert",
 *     "revision_delete" = "/admin/structure/digital_serial_issue/{digital_serial_issue}/revisions/{digital_serial_issue_revision}/delete",
 *     "collection" = "/admin/structure/digital_serial_issue",
 *   },
 *   field_ui_base_route = "digital_serial_issue.settings"
 * )
 */
class DigitalSerialIssue extends RevisionableContentEntityBase implements DigitalSerialIssueInterface {
  ...
  public function preSave(EntityStorageInterface $storage) {
    ...
    // If no revision author has been set explicitly, make the digital_serial_issue owner the
    // revision author.
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('The user ID of author of the Digital serial issue entity.'))
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ...
      ->setDescription(t('A boolean indicating whether the Digital serial issue is published.'))
      ->setRevisionable(TRUE)
