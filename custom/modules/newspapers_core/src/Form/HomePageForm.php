...
class HomePageForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $about_markup = '<p>The New Brunswick Historical Newspapers Project provides researchers with unified
      access to UNB Libraries&apos; current and historical newspaper collections in all formats,
      from New Brunswick and across the world. Search our index for all known New Brunswick newspapers and discover
      <a href="/print-titles">print</a>, microform, and selected digital titles available from UNB Libraries.
      Learn more <a href="/project">about the NBHNP</a> or how we
      <a href="/determining-newspaper-digitization-priorities">determine newspaper digitization priorities</a>.</p>
      <p>We appreciate your interest in this project and would be
